...
| **In progress** | T-004 done 2026-09-01 — T-004a (wa.domain POCOs, 15 tables) + T-004b (TA-3.2 DDL as EF migration `InitialCreate`). Build + format + unit + integration + web gate green. Next: T-005 (Limits Registry). |
