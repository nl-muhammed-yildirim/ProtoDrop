# T-032 — Stage and remove multiple files

**Story:** US-001-02 | **Feature:** F-TRF-001 | **Phase:** 0 — MVP
**Story file:** `../features/Phase 0-MVP/F-TRF-001/US-001-02-stage-files.md`
...
As a sender, I want to add several files to a single transfer and remove any of them before sending, so that I can correct a wrong selection without starting over.
...
- [x] Scenario 1: the staging list has 2 files
- [x] Scenario 2: I stage two files named "report.pdf"
...
- [x] AGENT.md §4 test gate green — domain 11/11, application 12/12, web lint ✓ / vitest 26/26 / tsc+vite build ✓ (2026-09-15). `api.integration` = 10 component-level tests green; remaining 5 are Testcontainers and need Docker (env: daemon was down this session).

## Links

- Story: `../features/Phase 0-MVP/F-TRF-001/US-001-02-stage-files.md`
