# T-045 — See remaining downloads and expired states

**Story:** US-003-05 | **Feature:** F-TRF-003 | **Phase:** 0 — MVP
**Story file:** `../features/Phase 0-MVP/F-TRF-003/US-003-05-remaining-expired.md`
...
As a recipient, I want the page to tell me the true state of my transfer — how many downloads are left, that it expired, that it was never a link, or that all downloads were used — so that I know whether to download or to contact the sender.
...
- [ ] Scenario 1: an active transfer with a finite cap that has been downloaded once
...
- Story: `../features/Phase 0-MVP/F-TRF-003/US-003-05-remaining-expired.md`
